...
- For now, this project only supports the same architecture as was originally provided.
...
When you stop a simulation, useful information will be saved inside the folder **'output'**. You can also check the error and RMSE score in separate graphs. Those 3 files will be overwritten once you start a new simulation, and if you quit the program without explicitely stopping a simulation, the generated data will be lost.